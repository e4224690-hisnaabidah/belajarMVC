...
<head>
 ...
 <title>Edit Harga Skincare Herbal</title>
 <style>
    * {
        margin: 0;
        padding: 0;
...
<body>
    ...
    <form action="/produk/update-harga" method="POST">
        ...
        <h2>Form Ubah Harga Skincare Herbal</h2>

        <p>Nama Produk: <b>Herbal Glow Serum</b></p>
        <p>Kategori: <b>Serum</b></p>
        <p>Harga Saat Ini: <b>Rp120.000</b></p>
